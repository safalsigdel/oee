					...
					<form action="stu_reg_process.php" method="post" class="w3_form_post">
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" pattern="[a-zA-Z]+" name="name" placeholder="Your Full Name" required="">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Address  </label>
								<input type="text" pattern="[A-Za-z]+" name="address" placeholder="Your Address" required="">
								</span>
						</div>
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" pattern="[A-Za-z]+" name="fatname" placeholder="Your Father Name" required="">
								</span>
						</div>
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" name="phone" pattern="[0-9]+" placeholder="Phone Number" required="">
								</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
